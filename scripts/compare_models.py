"""
Compares all trained models by aggregating metrics, training time, AUC,
and optionally nested CV scores into a summary CSV, barplot, and heatmap.
"""
...
plt.ylim([0, 1.45])  # extra space for legend above bars
plt.xlabel("Model")
plt.ylabel("Value")
